            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    <div className="feature-card bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-3xl shadow-xl">
                        ...
                        <h3 className="text-2xl font-semibold mb-4 text-gray-800">Smart ToDo List</h3>
                    ...
                    <div className="feature-card bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-3xl shadow-xl">
                        ...
                        <h3 className="text-2xl font-semibold mb-4 text-gray-800">Study Schedule</h3>
                    ...
                    <div className="feature-card bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-3xl shadow-xl">
                        ...
                        <h3 className="text-2xl font-semibold mb-4 text-gray-800">Focus Timer</h3>
